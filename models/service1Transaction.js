...
let Service1Transaction = sequelize.define(
    'service1Transaction',
    {
        id: {
        ...
        // Service type: 'Mobile2Recharge', 'DTH2Recharge', 'Pan2'
        serviceType: {
            type: DataTypes.STRING,
            allowNull: false,
            validate: {
                isIn: [['Mobile2Recharge', 'DTH2Recharge', 'Pan2']]
            },
            index: true
        },
...
Service1Transaction.belongsTo(User, { foreignKey: 'refId', as: 'user' });

Service1Transaction.prototype.toJSON = function () {
    let values = Object.assign({}, this.get());
    return values;
};

sequelizeTransforms(Service1Transaction);
sequelizePaginate.paginate(Service1Transaction);

module.exports = Service1Transaction;
