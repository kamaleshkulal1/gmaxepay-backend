...
const walletBalance = async (req, res) => {
    try {
        ...
        const allowedRoles = [3, 4, 5, 6];
        if (!allowedRoles.includes(existingUser.userRole)) {
        ...
        const response = {
            mainWallet: wallet?.mainWallet.toFixed(3) || 0,
            apes1Wallet: wallet?.apes1Wallet.toFixed(3) || 0,
            apes2Wallet: wallet?.apes2Wallet.toFixed(3) || 0
        }
